import { Box, Typography, Paper, Table, TableBody, TableCell, TableHead, TableRow, TableContainer, Button, TextField } from '@mui/material'
...
export const FooList = (): React.JSX.Element => {
  ...
  const [editableFoo, updateFoo] = useState<Foo[]>([])
  ...
  // const [updatedFoo, dispatch] = useActionState(updateFoo, editableFoo)
  ...
  useEffect(() => updateFoo(foo ?? []),[isSuccess])
